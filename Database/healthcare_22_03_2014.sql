...
INSERT INTO `healthcenter` VALUES (22,'super_healthcenter',4,NULL),(23,'super_healthcenter',4,NULL),(24,'super_healthcenter',4,NULL),(25,'healthcente3',4,NULL);
...
INSERT INTO `patient` VALUES (1,'ss','ss','ss',NULL,NULL,NULL,'','','','','','','','','','','',NULL,'','','','','','','','','',NULL,NULL,'');
...
INSERT INTO `user_roles` VALUES (1,1,'ROLE_USER'),(2,1,'ROLE_ADMIN'),(3,3,'ROLE_HEALTHCENTER'),(4,3,'ROLE_HC_ADMIN'),(5,3,'ROLE_USER'),(6,4,'ROLE_HC_ADMIN'),(7,4,'ROLE_USER'),(8,4,'ROLE_HEALTHCENTER'),(9,5,'ROLE_HEALTHCENTER'),(10,5,'ROLE_USER'),(11,5,'ROLE_HC_ADMIN'),(12,6,'ROLE_HEALTHCENTER'),(13,6,'ROLE_USER'),(14,6,'ROLE_HC_ADMIN');
...
CREATE TABLE `users` (
  ...
  `healthcentercode` int(11) NOT NULL,
  PRIMARY KEY (`USER_ID`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (1,'admin','admin',1,1),(3,'sdfa','ds',1,25),(4,'hc25admin','addd',1,24),(5,'ada','dd',1,24),(6,'ysna','ysna',1,24);
...
-- Dump completed on 2014-03-22 16:52:02
