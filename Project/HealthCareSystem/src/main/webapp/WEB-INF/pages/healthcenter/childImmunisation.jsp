...
<template:page pageTitle="${pageTitle}" bodyCss="home">
	<div class="content">
		...
		<div class="rightSection">
			...
			<form:form method="post" action="childImmunisation" commandName="childImmunisation">
				...
				<table>
					...
					<tr>
						<td>opvo_at_birth</td>
						<td><form:input path="opvo_at_birth" /></td>
					</tr>
					...
					<tr>
						<td colspan="2"><input type="submit" value="SubmitchildImmunisation" />
						</td>
					</tr>
