<div id="sidebar" class="sidebar">
	<div class="sidebar-shortcuts" id="sidebar-shortcuts">
		<ul class="nav nav-list" >
			...
			<li id="addState"><a href="${pageContext.request.contextPath}/admin/addState"> <i class="icon-desktop"></i><span
					class="menu-text"> Add State </span>
			</a></li>
			...
			<li id="addHCAdmin"><a href="${pageContext.request.contextPath}/admin/addHCAdmin"> <i class="icon-desktop"></i> <span
					class="menu-text"> Add HC Admin </span>
			</a></li>
			
			<li id="addDHSAdmin"><a href="${pageContext.request.contextPath}/admin/addDHSAdmin"> <i class="icon-desktop"></i> <span
					class="menu-text"> Add DHS Admin </span>
			</a></li>
